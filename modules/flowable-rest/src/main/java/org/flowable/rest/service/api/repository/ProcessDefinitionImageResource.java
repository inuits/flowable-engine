...
<<<<<<< HEAD
    ...
    public ResponseEntity<byte[]> getModelResource(@ApiParam(name = "processDefinitionId") @PathVariable String processDefinitionId, @RequestHeader(required = false, value = "x-tenant") String tenantId) {
